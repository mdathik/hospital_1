...
public class AppointmentDAO {
	...
	public boolean addAppointment(Appointment ap) {
		...
		try {
			...
			String sql = "insert into appointment(user_id,fullname,gender,age,appoint_date,time_range,phno,diseases,doctor_id,address,status) values(?,?,?,?,?,?,?,?,?,?,?)";
			...
			ps.setString(6, ap.gettimerange());
	...
	public List<Appointment> getAllAppointmentByLoginUser(int userId) {
		...
		try {
			...
			while (rs.next()) {
				...
				ap.settimerange(rs.getString(7));
