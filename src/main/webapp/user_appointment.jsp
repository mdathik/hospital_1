...
.backImg {
	background: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)),
		url("https://static.vecteezy.com/system/resources/thumbnails/023/639/130/small/molecular-structure-with-hospital-cross-for-medical-chemistry-and-science-concept-background-illustration-vector.jpg");
	height: 20vh;
	width: 100%;
	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="" src="https://www.shutterstock.com/image-vector/doctor-visiting-patient-hospital-female-600nw-2477344121.jpg">
			</div>
					...
					<div class="card-body">
						...
						<form class="row g-3" action="appAppointment" method="post">
							...
							<div class="col-md-6">
								...
								<div class="col-md-6">
								<label for="start_time">Select Time:</label><br>
...
<label for="end_time" hidden></label>
